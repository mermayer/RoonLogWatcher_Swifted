    ...
    * { box-sizing: border-box; }
    ...
    const HELP = {
      en: {
        ...
        "section.sources": "Current non-rotated log files. Rotated archives are kept in the source details instead of the main list.",
        ...
        "sources.count": "Current sources in the main list plus inactive rotated archives in the details.",
        ...
        "settings.maxFiles": "Maximum number of newest matching files per log directory. Keeping this moderate avoids scanning old archives unnecessarily.",
        ...
        "source.status": "Current watcher status for this file. Rotated archive files are kept out of the main list and shown in the details.",
      ...
      de: {
        ...
        "section.sources": "Aktuelle nicht-rotierte Logdateien. Rotierte Archive bleiben in den Quelldetails statt in der Hauptliste.",
        ...
        "sources.count": "Aktuelle Quellen in der Hauptliste plus inaktive rotierte Archive in den Details.",
        ...
        "settings.maxFiles": "Maximale Anzahl neuester passender Dateien pro Logordner. Moderate Werte vermeiden unnötiges Scannen alter Archive.",
        ...
        "source.status": "Aktueller Watcher-Status dieser Datei. Rotierte Archivdateien bleiben aus der Hauptliste heraus und erscheinen in den Details.",
